package io.github.jtsato.moviesbattle.entrypoint.rest.common.metric;
...
public class LogExecutionTimeImpl {
    ...
    @SneakyThrows
    @Around("@annotation(io.github.jtsato.moviesbattle.entrypoint.rest.common.metric.LogExecutionTime)")
